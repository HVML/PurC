...
enum myhvml_tag_categories {
    ...
    MyHVML_TAG_CATEGORIES_FORMATTING       = 0x004,
    MyHVML_TAG_CATEGORIES_SCOPE            = 0x008,
    MyHVML_TAG_CATEGORIES_SCOPE_LIST_ITEM  = 0x010,
    MyHVML_TAG_CATEGORIES_SCOPE_BUTTON     = 0x020,
    MyHVML_TAG_CATEGORIES_SCOPE_TABLE      = 0x040,
    MyHVML_TAG_CATEGORIES_SCOPE_SELECT     = 0x080
};
...
enum myhvml_insertion_mode {
    ...
    MyHVML_INSERTION_MODE_IN_HEAD_NOSCRIPT     = 0x004,
    MyHVML_INSERTION_MODE_AFTER_HEAD           = 0x005,
    MyHVML_INSERTION_MODE_IN_BODY              = 0x006,
    MyHVML_INSERTION_MODE_TEXT                 = 0x007,
    MyHVML_INSERTION_MODE_IN_TABLE             = 0x008,
    MyHVML_INSERTION_MODE_IN_TABLE_TEXT        = 0x009,
    MyHVML_INSERTION_MODE_IN_CAPTION           = 0x00a,
    MyHVML_INSERTION_MODE_IN_COLUMN_GROUP      = 0x00b,
    MyHVML_INSERTION_MODE_IN_TABLE_BODY        = 0x00c,
    MyHVML_INSERTION_MODE_IN_ROW               = 0x00d,
    MyHVML_INSERTION_MODE_IN_CELL              = 0x00e,
    MyHVML_INSERTION_MODE_IN_SELECT            = 0x00f,
    MyHVML_INSERTION_MODE_IN_SELECT_IN_TABLE   = 0x010,
    MyHVML_INSERTION_MODE_IN_TEMPLATE          = 0x011,
    MyHVML_INSERTION_MODE_AFTER_BODY           = 0x012,
    MyHVML_INSERTION_MODE_IN_FRAMESET          = 0x013,
    MyHVML_INSERTION_MODE_AFTER_FRAMESET       = 0x014,
    MyHVML_INSERTION_MODE_AFTER_AFTER_BODY     = 0x015,
    MyHVML_INSERTION_MODE_AFTER_AFTER_FRAMESET = 0x016,
