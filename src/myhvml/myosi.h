...
enum myhvml_tokenizer_state {
    ...
    MyHVML_TOKENIZER_STATE_AFTER_DOCTYPE_PREFIX_KEYWORD,
    ...
    MyHVML_TOKENIZER_STATE_BETWEEN_DOCTYPE_PREFIX_AND_TARGET_IDENTIFIERS,

    MyHVML_TOKENIZER_STATE_AFTER_DOCTYPE_TARGET_KEYWORD,
    MyHVML_TOKENIZER_STATE_BEFORE_DOCTYPE_TARGET_IDENTIFIER,
    MyHVML_TOKENIZER_STATE_DOCTYPE_TARGET_IDENTIFIER_DOUBLE_QUOTED,
    MyHVML_TOKENIZER_STATE_DOCTYPE_TARGET_IDENTIFIER_SINGLE_QUOTED,
    MyHVML_TOKENIZER_STATE_AFTER_DOCTYPE_TARGET_IDENTIFIER,

    MyHVML_TOKENIZER_STATE_BETWEEN_DOCTYPE_TARGET_AND_SYSTEM_IDENTIFIERS,
