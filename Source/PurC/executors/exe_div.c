...
static inline bool
exe_div_parse_rule(purc_exec_inst_t inst, const char* rule)
{
...
exe_div_choose(purc_exec_inst_t inst, const char* rule)
{
    ...
    if (!exe_div_parse_rule(inst, rule))
        return PURC_VARIANT_INVALID;
...
exe_div_destroy(purc_exec_inst_t inst)
{
    ...
    struct pcexec_exe_div_inst *exe_div_inst = (struct pcexec_exe_div_inst*)inst;

    if (exe_div_inst->super.input) {
        purc_variant_unref(exe_div_inst->super.input);
        exe_div_inst->super.input = PURC_VARIANT_INVALID;
    }
    if (exe_div_inst->super.selected_keys) {
        purc_variant_unref(exe_div_inst->super.selected_keys);
        exe_div_inst->super.selected_keys = PURC_VARIANT_INVALID;
    }
