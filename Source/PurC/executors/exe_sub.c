...
static inline bool
exe_sub_parse_rule(purc_exec_inst_t inst, const char* rule)
{
...
exe_sub_choose(purc_exec_inst_t inst, const char* rule)
{
    ...
    if (!exe_sub_parse_rule(inst, rule))
        return PURC_VARIANT_INVALID;
...
exe_sub_destroy(purc_exec_inst_t inst)
{
    ...
    struct pcexec_exe_sub_inst *exe_sub_inst = (struct pcexec_exe_sub_inst*)inst;

    if (exe_sub_inst->super.input) {
        purc_variant_unref(exe_sub_inst->super.input);
        exe_sub_inst->super.input = PURC_VARIANT_INVALID;
    }
    if (exe_sub_inst->super.selected_keys) {
        purc_variant_unref(exe_sub_inst->super.selected_keys);
        exe_sub_inst->super.selected_keys = PURC_VARIANT_INVALID;
    }
