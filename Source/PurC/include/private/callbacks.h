 ...
 * @author Vincent Wei
 * @date 2022/01/29
 * @brief The general callback prototypes.
 *
...
/** The callback function prototype for freeing a datum. */
...
/** The callback function prototype for freeing a pair of key and value. */
typedef void (*pcutils_free_kv_fn)(void *key, void *val);

#endif /* PURC_PRIVATE_CALLBACKS_H */
