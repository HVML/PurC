...
enum {
    ...
    PURC_EXCEPT_LAST = PURC_EXCEPT_MAX_EMBEDDED_LEVELS,
};
...
enum {
    ...
    PURC_ERROR_MAX_EMBEDDED_LEVELS,

    /* XXX: change this when you append a new error code */
    PURC_ERROR_LAST = PURC_ERROR_MAX_EMBEDDED_LEVELS,
};
...
enum {
    ...
    PCEJSON_ERROR_MAX_EMBEDDED_LEVELS,

    /* XXX: change this when you append a new error code */
    PCEJSON_ERROR_LAST = PCEJSON_ERROR_MAX_EMBEDDED_LEVELS,
};
