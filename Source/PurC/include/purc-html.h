...
enum pchtml_html_serialize_opt {
    PCHTML_HTML_SERIALIZE_OPT_UNDEF               = 0x0000,
    PCHTML_HTML_SERIALIZE_OPT_SKIP_WS_NODES       = 0x0001,
    PCHTML_HTML_SERIALIZE_OPT_SKIP_COMMENT        = 0x0002,
    PCHTML_HTML_SERIALIZE_OPT_RAW                 = 0x0004,
    PCHTML_HTML_SERIALIZE_OPT_WITHOUT_CLOSING     = 0x0008,
    PCHTML_HTML_SERIALIZE_OPT_TAG_WITH_NS         = 0x0010,
    PCHTML_HTML_SERIALIZE_OPT_WITHOUT_TEXT_INDENT = 0x0020,
    PCHTML_HTML_SERIALIZE_OPT_FULL_DOCTYPE        = 0x0040,
    PCHTML_HTML_SERIALIZE_OPT_WITH_HVML_HANDLE    = 0x0080,
    PCHTML_HTML_SERIALIZE_OPT_MASK_C0CTRLS        = 0x0F00,
    PCHTML_HTML_SERIALIZE_OPT_KEEP_C0CTRLS        = 0x0000,
    PCHTML_HTML_SERIALIZE_OPT_IGNORE_C0CTRLS      = 0x0100,
    PCHTML_HTML_SERIALIZE_OPT_READABLE_C0CTRLS    = 0x0200,
};
