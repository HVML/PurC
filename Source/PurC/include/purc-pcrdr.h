...
#define PCRDR_OPERATION_REMOVEPAGEGROUP     "removePageGroup"
    PCRDR_K_OPERATION_CREATEPAGE,
#define PCRDR_OPERATION_CREATEPAGE          "createPage"
    PCRDR_K_OPERATION_UPDATEPAGE,
#define PCRDR_OPERATION_UPDATEPAGE          "updatePage"
    PCRDR_K_OPERATION_DESTROYPAGE,
#define PCRDR_OPERATION_DESTROYPAGE         "destroyPage"
...
#define PCRDR_OPERATION_CALLMETHOD          "callMethod"
    PCRDR_K_OPERATION_CALLMETHODNORETURN,
#define PCRDR_OPERATION_CALLMETHODNORETURN  "callMethodNoReturn"

    /* XXX: change this when you append a new operation */
    PCRDR_K_OPERATION_LAST = PCRDR_K_OPERATION_CALLMETHODNORETURN,
};
