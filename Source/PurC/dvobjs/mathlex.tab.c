...
#define yyparse         mathparse
#define yylex           mathlex
#define yyerror         matherror
#define yydebug         mathdebug
#define yynerrs         mathnerrs
...
#define YYBACKUP(Token, Value)                                    \
  do                                                              \
    if (yychar == YYEMPTY)                                        \
      ...
      {                                                           \
        yyerror (myparam, arg, YY_("syntax error: cannot back up")); \
        YYERROR;                                                  \
      }                                                           \
  while (0)
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, struct pcdvobjs_math_param * myparam, yyscan_t arg)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (myparam);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, struct pcdvobjs_math_param * myparam, yyscan_t arg)
{
  YYFPRINTF (yyo, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyo, yytype, yyvaluep, myparam, arg);
  YYFPRINTF (yyo, ")");
}
...
static void
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, int yyrule, struct pcdvobjs_math_param * myparam, yyscan_t arg)
{
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, myparam, arg); \
} while (0)
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, struct pcdvobjs_math_param * myparam, yyscan_t arg)
{
  YYUSE (yyvaluep);
  YYUSE (myparam);
  YYUSE (arg);
...
int
yyparse (struct pcdvobjs_math_param * myparam, yyscan_t arg)
{
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (myparam, arg, YY_("syntax error"));
#else
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, myparam, arg);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (myparam, arg, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  yystos[*yyssp], yyvsp, myparam, arg);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
