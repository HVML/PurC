...
pcintr_string_to_symbol_var(const char *str)
{
    ...
    if (strcmp(str, PURC_SYMBOL_VAR_ALIAS_POS) == 0) {
        return PURC_SYMBOL_VAR_POS;
    } else if (strcmp(str, PURC_SYMBOL_VAR_ALIAS_RES) == 0) {
        return PURC_SYMBOL_VAR_RES;
    } else if (strcmp(str, PURC_SYMBOL_VAR_ALIAS_USR) == 0) {
        return PURC_SYMBOL_VAR_USR;
    } else if (strcmp(str, PURC_SYMBOL_VAR_ALIAS_CNT) == 0) {
        return PURC_SYMBOL_VAR_CNT;
    } else if (strcmp(str, PURC_SYMBOL_VAR_ALIAS_KEY) == 0) {
        return PURC_SYMBOL_VAR_KEY;
    } else if (strcmp(str, PURC_SYMBOL_VAR_ALIAS_VAL) == 0) {
        return PURC_SYMBOL_VAR_VAL;
        ...
        enum purc_symbol_var symbol, purc_variant_t val)
{
    ...
    return pcintr_set_symbol_var(frame, symbol, val);
}
