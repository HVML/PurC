...
public:
    ...
    PURC_EXPORT Ref<FormData> isolatedCopy() const;
    ...
    PURC_EXPORT FormDataForUpload prepareForUpload();
    ...
    PURC_EXPORT uint64_t lengthInBytes() const;

    PURC_EXPORT URL asBlobURL() const;
