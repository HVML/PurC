...
#define ETT_GET_MEMBER_BY_BRACKET       'B'         /* $VARIABLE[ELEMENT] */
...
enum pcejson_tkz_state {
    ...
    EJSON_TKZ_STATE_OP_MUL,
    EJSON_TKZ_STATE_OP_DIV,
    EJSON_TKZ_STATE_OP_MOD,
    EJSON_TKZ_STATE_OP_EQUAL,
    EJSON_TKA_STATE_OP_NOT_EQUAL,
    EJSON_TKA_STATE_OP_GREATER,
    EJSON_TKA_STATE_OP_LESS,
    EJSON_TKA_STATE_OP_BITWISE_AND,
    EJSON_TKA_STATE_OP_BITWISE_OR,
    EJSON_TKA_STATE_OP_BITWISE_INVERT,
    EJSON_TKA_STATE_OP_BITWISE_XOR,
    EJSON_TKA_STATE_OP_BITWISE_LEFT_SHIFT,
    EJSON_TKA_STATE_OP_BITWISE_RIGHT_SHIFT,
    EJSON_TKA_STATE_OP_CONDITIONAL,
    EJSON_TKA_STATE_OP_COMMA,
    EJSON_TKA_STATE_OP_AND,
    EJSON_TKA_STATE_OP_OR,
    EJSON_TKA_STATE_OP_NOT,
    EJSON_TKA_STATE_OP_IN,

    EJSON_TKZ_STATE_LAST = EJSON_TKA_STATE_OP_IN,
};
