...
static struct err_msg_info generic_err_msgs[] = {
    /* PURC_ERROR_OK */
    { "Ok", NULL, PURC_EXCEPT_FLAGS_NONE, 0},
    /* PURC_ERROR_BAD_SYSTEM_CALL */
    { "Bad system call", PURC_EXCEPT_OS_ERROR, PURC_EXCEPT_FLAGS_NONE, 0},
    ...
    { "Duplicated", PURC_EXCEPT_BAD_VALUE, PURC_EXCEPT_FLAGS_NONE, 0},
    /* PURC_ERROR_NOT_IMPLEMENTED */
    { "Not implemented", PURC_EXCEPT_NOT_IMPLEMENTED, PURC_EXCEPT_FLAGS_NONE, 0},
    /* PURC_ERROR_NO_INSTANCE */
    { "No instance", PURC_EXCEPT_NOT_READY, PURC_EXCEPT_FLAGS_NONE, 0},
    /* PURC_ERROR_TOO_LARGE_ENTITY */
    { "Tool large entity", PURC_EXCEPT_TOO_LONG, PURC_EXCEPT_FLAGS_NONE, 0},
    /* PURC_ERROR_BAD_ENCODING */
    { "Bad encoding", PURC_EXCEPT_BAD_ENCODING, PURC_EXCEPT_FLAGS_NONE, 0},
    /* PURC_ERROR_NOT_SUPPORTED */
    { "Not supported", PURC_EXCEPT_NOT_IMPLEMENTED, PURC_EXCEPT_FLAGS_NONE, 0},
    /* PURC_ERROR_OUTPUT */
    {
    ...
    { "Too small size", PURC_EXCEPT_BAD_VALUE, PURC_EXCEPT_FLAGS_NONE, 0},
