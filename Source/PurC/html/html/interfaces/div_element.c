 ...
 * @author 
 * @date 2021/07/02
 * @brief The complementation of html div element.
 *
...
pchtml_html_div_element_interface_create(pchtml_html_document_t *document)
{
    pchtml_html_div_element_t *element;

    element = pchtml_mraw_calloc(document->dom_document.mraw,
                                 sizeof(pchtml_html_div_element_t));
    if (element == NULL) {
        return NULL;
    }
...
pchtml_html_div_element_t *
pchtml_html_div_element_interface_destroy(pchtml_html_div_element_t *div_element)
{
    return pchtml_mraw_free(
        pchtml_dom_interface_node(div_element)->owner_document->mraw,
        div_element);
}
