/**
 * @file frame_element.h
 * @author 
 * @date 2021/07/02
 * @brief The hearder file for html frame element.
 *
...
struct pchtml_html_frame_element {
    pchtml_html_element_t element;
};


pchtml_html_frame_element_t *
pchtml_html_frame_element_interface_create(
                pchtml_html_document_t *document) WTF_INTERNAL;

pchtml_html_frame_element_t *
pchtml_html_frame_element_interface_destroy(
                pchtml_html_frame_element_t *frame_element) WTF_INTERNAL;
