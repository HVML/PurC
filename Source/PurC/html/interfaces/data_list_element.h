...
#ifndef PCHTML_PARSER_DATA_LIST_ELEMENT_H
#define PCHTML_PARSER_DATA_LIST_ELEMENT_H
...
pchtml_html_data_list_element_interface_create(
                pchtml_html_document_t *document) WTF_INTERNAL;

pchtml_html_data_list_element_t *
pchtml_html_data_list_element_interface_destroy(
                pchtml_html_data_list_element_t *data_list_element) WTF_INTERNAL;
...
#endif  /* PCHTML_PARSER_DATA_LIST_ELEMENT_H */
