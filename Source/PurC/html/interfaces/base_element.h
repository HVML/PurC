 ...
 * @author 
 * @date 2021/07/02
 * @brief The hearder file for html base element.
 *
...
pchtml_html_base_element_interface_create(
                pchtml_html_document_t *document) WTF_INTERNAL;

pchtml_html_base_element_t *
pchtml_html_base_element_interface_destroy(
                pchtml_html_base_element_t *base_element) WTF_INTERNAL;
