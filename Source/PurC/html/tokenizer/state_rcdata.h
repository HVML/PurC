 ...
 * @author 
 * @date 2021/07/02
 * @brief The hearder file for html rcdata state.
 *
...
#ifndef PCHTML_PARSER_TOKENIZER_STATE_RCDATA_H
#define PCHTML_PARSER_TOKENIZER_STATE_RCDATA_H
...
#endif  /* PCHTML_PARSER_TOKENIZER_STATE_RCDATA_H */
