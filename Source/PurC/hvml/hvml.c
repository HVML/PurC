...
enum pchvml_state {
    ...
    PCHVML_TEXT_CONTENT_STATE,
    PCHVML_JSONTEXT_CONTENT_STATE,
    PCHVML_JSONEE_ATTRIBUTE_VALUE_DOUBLE_QUOTED_STATE,
    PCHVML_JSONEE_ATTRIBUTE_VALUE_SINGLE_QUOTED_STATE,
    PCHVML_JSONEE_ATTRIBUTE_VALUE_UNQUOTED_STATE,
