...
enum tokenizer_state {
    ...
    HVML_EJSON_VALUE_NUMBER_HEX_STATE,
    HVML_EJSON_VALUE_NUMBER_HEX_SUFFIX_ISTATE,
    HVML_EJSON_AFTER_VALUE_NUMBER_HEX_STATE,
    ...
    HVML_EJSON_AMPERSAND_STATE,
    HVML_EJSON_OR_SIGN_STATE,
    HVML_EJSON_SEMICOLON_STATE,
    HVML_EJSON_CJSONEE_FINISHED_STATE,

    HVML_LAST_STATE = HVML_EJSON_CJSONEE_FINISHED_STATE,
};
