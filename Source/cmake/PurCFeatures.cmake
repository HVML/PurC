...
macro(PURC_OPTION_BEGIN)
    ...
    PURC_OPTION_DEFINE(ENABLE_RDRCM_THREAD "Toggle the renderer communication method `thread`" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_RDRCM_SOCKET "Toggle the renderer communication method `socket`" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_RDRCM_HBDBUS "Toggle the renderer communication method `hbdbus` (reserved for future)" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_EXTDVOBJ_MATH "Toggle the external dynamic object $MATH (support for mathematics)" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_EXTDVOBJ_FS "Toggle the external dynamic object $FS (support for operations on file system and file)" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_EXTDVOBJ_PY "Toggle the external dynamic object $PY (support for Python)" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_EXTDVOBJ_SQLITE "Toggle the external dynamic object $SQLITE (support for SQLite)" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_DOCTYPE_HTML "Toggle HTML parser (always on)" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_DOCTYPE_XML "Toggle XML parser (reserved for future)" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_DOCTYPE_XGML "Toggle XGML parser (reserved for future)" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_STREAM_HBDBUS "Toggle support for HBDBus protocol on stream" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_STREAM_HTTP "Toggle support for HTTP protocol on stream (reserved for future)" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_STREAM_MQTT "Toggle support for MQTT protocol on stream (reserved for future)" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_STREAM_WEB_SOCKET "Toggle support for WebSocket protocol on stream (reserved for future)" PUBLIC ON)

    PURC_OPTION_DEFINE(ENABLE_SCHEME_LCMD "Toggle support for LCMD schema in the remote fetcher" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_SCHEME_LSQL "Toggle support for LSQL schema in the remote fetcher" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_SCHEME_RSQL "Toggle support for RSQL schema in the remote fetcher" PUBLIC ON)
    PURC_OPTION_DEFINE(ENABLE_SCHEME_HTTP "Toggle support for HTTP schema in the remote fetcher" PUBLIC ON)
