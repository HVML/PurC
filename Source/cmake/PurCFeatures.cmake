...
macro(PURC_OPTION_BEGIN)
    ...
    PURC_OPTION_DEFINE(ENABLE_REMOTE_FETCHER "Toggle use of the remote PurC Fetcher" PUBLIC ${ENABLE_REMOTE_FETCHER_DEFAULT})
    ...
    PURC_OPTION_DEFINE(ENABLE_LCMD "Toggle support for LCMD protocol" PUBLIC ${ENABLE_LCMD_DEFAULT})
    PURC_OPTION_DEFINE(ENABLE_LSQL "Toggle support for LSQL protocol" PUBLIC ${ENABLE_LSQL_DEFAULT})
    PURC_OPTION_DEFINE(ENABLE_RSQL "Toggle support for RSQL protocol" PUBLIC ${ENABLE_RSQL_DEFAULT})
