        ...
        const pcrdr_msg *msg)
{
    ...
    if ((tmp = purc_variant_object_get_by_ckey(msg->data, "title", true))) {
        ...
        const pcrdr_msg *msg)
{
    ...
    if (msg->dataType == PCRDR_MSG_DATA_TYPE_JSON
           && purc_variant_is_object(msg->data)) {
        if ((tmp = purc_variant_object_get_by_ckey(msg->data, "class", true))) {
        ...
        const pcrdr_msg *msg)
{
    ...
    toolkit_style = purc_variant_object_get_by_ckey(msg->data,
            "toolkitStyle", true);
        ...
        const pcrdr_msg *msg)
{
    ...
    if ((arg = purc_variant_object_get_by_ckey(msg->data, "method", true))) {
    ...
    arg = purc_variant_object_get_by_ckey(msg->data, "arg", true);
    const char *element_value;
