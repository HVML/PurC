...
#define SQLITE_AFFINITY_TYPE_NAME_TINYINT                   "tinyint"
    SQLITE_AFFINITY_TYPE_UNSIGNED_BIGINT,
#define SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_BIGINT           "unsigned bigint"
    SQLITE_AFFINITY_TYPE_UNSIGNED_INT,
#define SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_INT              "unsigned int"
    SQLITE_AFFINITY_TYPE_UNSIGNED_INT2,
#define SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_INT2             "unsigned int2"
    SQLITE_AFFINITY_TYPE_UNSIGNED_INT4,
#define SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_INT4             "unsigned int4"
    SQLITE_AFFINITY_TYPE_UNSIGNED_INT8,
#define SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_INT8             "unsigned int8"
    SQLITE_AFFINITY_TYPE_UNSIGNED_INTEGER,
#define SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_INTEGER          "unsigned integer"
    SQLITE_AFFINITY_TYPE_UNSIGNED_MEDIUMINT,
#define SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_MEDIUMINT        "unsigned mediumint"
    SQLITE_AFFINITY_TYPE_UNSIGNED_SMALLINT,
#define SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_SMALLINT         "unsigned smallint"
    SQLITE_AFFINITY_TYPE_UNSIGNED_TINYINT,
#define SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_TINYINT          "unsigned tinyint"
...
static struct affinity_type {
    ...
    {
        SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_BIGINT,
        SQLITE_AFFINITY_TYPE_UNSIGNED_BIGINT,
        PURC_VARIANT_TYPE_ULONGINT
    },
    {
        SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_INT,
        SQLITE_AFFINITY_TYPE_UNSIGNED_INT,
        PURC_VARIANT_TYPE_ULONGINT
    },
    {
        SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_INT2,
        SQLITE_AFFINITY_TYPE_UNSIGNED_INT2,
        PURC_VARIANT_TYPE_ULONGINT
    },
    {
        SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_INT4,
        SQLITE_AFFINITY_TYPE_UNSIGNED_INT4,
        PURC_VARIANT_TYPE_ULONGINT
    },
    {
        SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_INT8,
        SQLITE_AFFINITY_TYPE_UNSIGNED_INT8,
        PURC_VARIANT_TYPE_ULONGINT
    },
    {
        SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_INTEGER,
        SQLITE_AFFINITY_TYPE_UNSIGNED_INTEGER,
        PURC_VARIANT_TYPE_ULONGINT
    },
    {
        SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_MEDIUMINT,
        SQLITE_AFFINITY_TYPE_UNSIGNED_MEDIUMINT,
        PURC_VARIANT_TYPE_ULONGINT
    },
    {
        SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_SMALLINT,
        SQLITE_AFFINITY_TYPE_UNSIGNED_SMALLINT,
        PURC_VARIANT_TYPE_ULONGINT
    },
    {
        SQLITE_AFFINITY_TYPE_NAME_UNSIGNED_TINYINT,
        SQLITE_AFFINITY_TYPE_UNSIGNED_TINYINT,
        PURC_VARIANT_TYPE_ULONGINT
    },
    {
        ...
        int pos, const char *name, purc_variant_t name_mapping)
{
    ...
    purc_variant_t v =
        purc_variant_object_get_by_ckey(name_mapping, name, false);
    if (!v) {
        val = purc_variant_make_string(name, true);
        goto out;
    }
        ...
        int pos, const char *name, purc_variant_t type_conversion)
{
    ...
    purc_variant_t v =
        purc_variant_object_get_by_ckey(type_conversion, name, false);
    if (!v) {
        val = sqlite_value_to_variant(cursor->conn->db, cursor->st, pos);
        goto out;
    }
...
get_cursor_from_root(purc_variant_t root)
{
    ...
    v = purc_variant_object_get_by_ckey(root, SQLITE_KEY_HANDLE, true);
            ...
            size_t nr_args, purc_variant_t* argv, unsigned call_flags)
{
    ...
    if (conn_exec_stmt(sqlite_connection, "BEGIN") < 0) {
        purc_set_error_with_info(PURC_ERROR_EXTERNAL_FAILURE,
                "sqlite error message is %s",
                sqlite3_errmsg(sqlite_connection->db));
        goto failed;
    }
