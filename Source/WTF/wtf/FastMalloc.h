...
//     used outside of the component defining your class (e.g. your class is in xCore and it is also used in xGUI). In this case, you can use WTF_MAKE_ISO_ALLOCATED_EXPORT
//     to annotate these functions with appropriate export macros: e.g. WTF_MAKE_ISO_ALLOCATED_EXPORT(IDBTransaction, XCORE_EXPORT).
