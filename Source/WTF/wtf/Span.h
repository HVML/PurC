...
// - Renames std::span to PurCWTF::Span
// - Renames std::as_bytes/std::as_writable_bytes to PurCWTF::asBytes/PurCWTF::asWritableBytes.
...
#define _WTF_LIBCPP_BEGIN_NAMESPACE namespace PurCWTF {
...
using PurCWTF::Span;
using PurCWTF::asBytes;
using PurCWTF::asWritableBytes;
