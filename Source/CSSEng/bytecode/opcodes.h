...
enum op_list_style_type {
	...
	LIST_STYLE_TYPE_UPPER_ARMENIAN	= 0x000e,
	LIST_STYLE_TYPE_LOWER_ARMENIAN	= 0x000f,
	LIST_STYLE_TYPE_CJK_DECIMAL		= 0x0010,
	LIST_STYLE_TYPE_TIBETAN		= 0x0011,
	LIST_STYLE_TYPE_NONE		= 0x0012,
};
