...
TEST(hvml_tokenization, ejson_attr_value)
{
    char hvml[] = "<hvml value=$ABC></hvml>";
    purc_rwstream_t rws = purc_rwstream_new_from_mem(hvml, strlen(hvml));
...
TEST(hvml_tokenization, ejson_get_element)
{
    char hvml[] = "<hvml value=$ABC[0]></hvml>";
    purc_rwstream_t rws = purc_rwstream_new_from_mem(hvml, strlen(hvml));
