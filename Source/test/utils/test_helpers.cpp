...
TEST(test_transition_styles, transition_style)
{
    ...
    static struct positvie_case {
        ...
        { -1, "window-transition-move: linear -1", PURC_WINDOW_TRANSTION_FUNCTION_NONE, 0 },
        { 0, "window-transition-move: InQuad 100", PURC_WINDOW_TRANSTION_FUNCTION_INQUAD, 100 },
        { 0, "window-transition-move: InQuad 0", PURC_WINDOW_TRANSTION_FUNCTION_INQUAD, 0 },
        { 0, "window-transition-move: InQuad 99;", PURC_WINDOW_TRANSTION_FUNCTION_INQUAD, 99 },
        { 0, "window-transition-move: InQuad 99  aabb;", PURC_WINDOW_TRANSTION_FUNCTION_INQUAD, 99 },
        { -1, "window-transition-move: OutQuad -1", PURC_WINDOW_TRANSTION_FUNCTION_NONE, 0 },
        { 0, "window-transition-move: OutQuad 100", PURC_WINDOW_TRANSTION_FUNCTION_OUTQUAD, 100 },
        { 0, "window-transition-move: OutQuad 0", PURC_WINDOW_TRANSTION_FUNCTION_OUTQUAD, 0 },
        { 0, "window-transition-move: OutQuad 99;", PURC_WINDOW_TRANSTION_FUNCTION_OUTQUAD, 99 },
        { 0, "window-transition-move: OutQuad 99  aabb;", PURC_WINDOW_TRANSTION_FUNCTION_OUTQUAD, 99 },
        { -1, "window-transition-move: InOutQuad -1", PURC_WINDOW_TRANSTION_FUNCTION_NONE, 0 },
        { 0, "window-transition-move: InOutQuad 100", PURC_WINDOW_TRANSTION_FUNCTION_INOUTQUAD, 100 },
        { 0, "window-transition-move: InOutQuad 0", PURC_WINDOW_TRANSTION_FUNCTION_INOUTQUAD, 0 },
        { 0, "window-transition-move: InOutQuad 99;", PURC_WINDOW_TRANSTION_FUNCTION_INOUTQUAD, 99 },
        { 0, "window-transition-move: InOutQuad 99  aabb;", PURC_WINDOW_TRANSTION_FUNCTION_INOUTQUAD, 99 },
