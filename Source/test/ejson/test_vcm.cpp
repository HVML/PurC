...
int to_error(const char* err)
{
    ...
    TO_ERROR(PCRWSTREAM_ERROR_FBIG);
    TO_ERROR(PCRWSTREAM_ERROR_IO);
    TO_ERROR(PCRWSTREAM_ERROR_ISDIR);
    TO_ERROR(PCRWSTREAM_ERROR_NOSPC);
    TO_ERROR(PCRWSTREAM_ERROR_NXIO);
    TO_ERROR(PCRWSTREAM_ERROR_OVERFLOW);
    TO_ERROR(PCRWSTREAM_ERROR_PIPE);
    TO_ERROR(PCRWSTREAM_BAD_ENCODING);
