...
TEST(variant, arithmetic_operators)
{
    ...
    arithmetic_test_case test_cases[] = {
        ...
        { PURC_VARIANT_TYPE_BIGINT, PURC_VARIANT_TYPE_BIGINT,
            ...
            purc_variant_operator_add, "12200160415121876738N"},  // bigint + bigint
        { PURC_VARIANT_TYPE_BIGINT, PURC_VARIANT_TYPE_BIGINT,
            "7540113804746346429N", "12200160415121876738N",
            purc_variant_operator_add, "19740274219868223167N"},  // bigint + bigint
        ...
        { PURC_VARIANT_TYPE_BIGINT, PURC_VARIANT_TYPE_BIGINT,
            "4660046610375530309N", "19740274219868223167N",
            purc_variant_operator_sub, "-15080227609492692858N"},  // bigint - bigint
        ...
        { PURC_VARIANT_TYPE_BIGINT, PURC_VARIANT_TYPE_BIGINT,
            "18446744073709551614N", "2N", purc_variant_operator_mod, "0N"},  // bigint % bigint
        ...
        { PURC_VARIANT_TYPE_BIGINT, PURC_VARIANT_TYPE_BIGINT,
            "18446744073709551614N", "2N", purc_variant_operator_pow, "340282366920938463389587631136930004996N"},  // bigint ** bigint
    };
