...
// to test:
// purc_variant_string_append 
TEST(variant, pcvariant_string_append)
{
    purc_variant_t value = NULL;
    purc_instance_extra_info info = {0, 0};

    const char short_ok[] =  "12345678";
    const char short_append[] = "abcdef";
    const char long_ok[] = "123456789a123456";
    const char long_append[] = "abcdefghijk";
    ...
    ASSERT_EQ (length, strlen(purc_variant_get_string_const (value)) + 1);
    ASSERT_LT (length, real_size);
    ASSERT_STREQ(short_ok, purc_variant_get_string_const (value));

    value = purc_variant_string_append (value, short_append, true);
    ASSERT_NE(value, PURC_VARIANT_INVALID);
    length = purc_variant_string_length (value);
    ASSERT_EQ (length, strlen(purc_variant_get_string_const (value)) + 1);
    ASSERT_EQ (length, 15);
    ASSERT_LT (length, real_size);
    ASSERT_STREQ("12345678abcdef", purc_variant_get_string_const (value));
    purc_variant_unref(value);
    ...
    value = purc_variant_string_append (value, long_append, true);
    ASSERT_NE(value, PURC_VARIANT_INVALID);
    length = purc_variant_string_length (value);
    ASSERT_EQ (length, strlen(purc_variant_get_string_const (value)) + 1);
    ASSERT_EQ (length, 20);
    ASSERT_GT (length, real_size);
    ASSERT_STREQ("12345678abcdefghijk", purc_variant_get_string_const (value));
    purc_variant_unref(value);
    ...
    ASSERT_EQ (length, strlen(purc_variant_get_string_const (value)) + 1);
    ASSERT_GT (length, real_size);
    ASSERT_STREQ(long_ok, purc_variant_get_string_const (value));
    ...
    ASSERT_EQ (length, 28);
    ASSERT_GT (length, real_size);
    ASSERT_STREQ("123456789a123456abcdefghijk", purc_variant_get_string_const (value));
    purc_variant_unref(value);


    value = purc_variant_make_string ("", false);
    ASSERT_NE(value, PURC_VARIANT_INVALID);
    length = purc_variant_string_length (value);
    ASSERT_EQ (length, strlen(purc_variant_get_string_const (value)) + 1);
    ASSERT_LT (length, real_size);
    ASSERT_STREQ("", purc_variant_get_string_const (value));
    ASSERT_EQ (purc_variant_string_is_empty (value), true);
    ...
    ASSERT_EQ (length, 12);
    ASSERT_LT (length, real_size);
    ASSERT_STREQ("abcdefghijk", purc_variant_get_string_const (value));

    purc_variant_string_clear (value);
    ASSERT_EQ (purc_variant_string_is_empty (value), true);
