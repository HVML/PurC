/*
 * @file test-message-bad-client.c
 * @author Vincent Wei
 * @date 2025/02/27
...
TEST(message, plain_server_ltnr_client)
{
    PurCInstance purc(false);
    ...
    run_one_comp_test("dvobjs/socket/local-message-bad-client.hvml", "client=ltnr");
...
TEST(message, plain_server_tlmsg_client)
{
    PurCInstance purc(false);
