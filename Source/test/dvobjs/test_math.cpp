...
TEST(dvobjs, dvobjs_math_uname_prt)
{
    purc_variant_t param[10];
    purc_variant_t ret_var = NULL;
    const char * result = NULL;
...
TEST(dvobjs, dvobjs_math_get_local)
{
    purc_variant_t param[10];
    purc_variant_t ret_var = NULL;
...
TEST(dvobjs, dvobjs_math_set_local)
{
    purc_variant_t param[10];
    purc_variant_t ret_var = NULL;
...
TEST(dvobjs, dvobjs_math_get_random)
{
    purc_variant_t param[10];
    purc_variant_t ret_var = NULL;
