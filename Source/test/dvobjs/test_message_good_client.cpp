/*
 * @file test-message-good-client.c
 * @author Vincent Wei
 * @date 2025/02/27
...
TEST(message, plain_server_plain_client)
{
    ...
    run_one_comp_test("dvobjs/socket/local-message-good-client.hvml", "client=plain");
...
TEST(message, plain_server_lmsg_client)
{
    ...
    run_one_comp_test("dvobjs/socket/local-message-good-client.hvml", "client=lmsg");
