...
public:
    ...
    PURCFETCHER_EXPORT Ref<FormData> isolatedCopy() const;
    ...
    PURCFETCHER_EXPORT FormDataForUpload prepareForUpload();
    ...
    PURCFETCHER_EXPORT uint64_t lengthInBytes() const;

    PURCFETCHER_EXPORT URL asBlobURL() const;
