...
class ColumnIgnoreFilter : public FilterBase {
public:
    ColumnIgnoreFilter();
    virtual ~ColumnIgnoreFilter();
    virtual String name() { return "cignore"; }
    virtual FilterType type()  { return FilterTypeColumnCut; }
