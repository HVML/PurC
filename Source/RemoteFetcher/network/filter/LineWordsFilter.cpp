...
Vector<Row> LineWordsFilter::doFilter(Vector<Row> rowVec, String param)
{
    if (m_lang.isEmpty())
    {
...
Vector<Row> LineWordsFilter::splitRow(Row& row, String param)
{
    Vector<Row> rowVec;
    ...
    {
        Vector<String> splitRet = splitLine(row[i], param);
