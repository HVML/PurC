...
class LineLettersFilter : public FilterBase {
public:
    LineLettersFilter();
    virtual ~LineLettersFilter();
    virtual String name() { return "letters"; }
    virtual FilterType type()  { return FilterTypeLineSplit; }
