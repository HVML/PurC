...
macro(PURC_OPTION_BEGIN)
    ...
    PURC_OPTION_DEFINE(ENABLE_SOCKET "Toggle socket stream" PRIVATE ON)
    PURC_OPTION_DEFINE(ENABLE_HTML "Toggle HTML parser" PRIVATE ON)
    PURC_OPTION_DEFINE(ENABLE_XGML "Toggle XGML parser" PRIVATE ON)
    PURC_OPTION_DEFINE(ENABLE_XML "Toggle XML parser" PRIVATE ON)
    PURC_OPTION_DEFINE(ENABLE_LCMD "Toggle support for LCMD protocol" PRIVATE ON)
    PURC_OPTION_DEFINE(ENABLE_LSQL "Toggle support for LSQL protocol" PRIVATE ON)
    PURC_OPTION_DEFINE(ENABLE_RSQL "Toggle support for RSQL protocol" PRIVATE ON)
    PURC_OPTION_DEFINE(ENABLE_HTTP "Toggle support for HTTP protocol" PRIVATE ON)
    PURC_OPTION_DEFINE(ENABLE_HIBUS "Toggle support for hiBus protocol" PRIVATE ON)
    PURC_OPTION_DEFINE(ENABLE_WEB_SOCKET "Toggle support for WebSocket protocol" PRIVATE ON)
    PURC_OPTION_DEFINE(ENABLE_MQTT "Toggle support for MQTT protocol" PRIVATE ON)
    PURC_OPTION_DEFINE(ENABLE_API_TESTS "Enable public API unit tests" PRIVATE ON)
