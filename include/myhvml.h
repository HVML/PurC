...
enum myhvml_tags {
    ...
    MyHVML_TAG_TEST,
    MyHVML_TAG_UPDATE,
    MyHVML_TAG__END_OF_FILE,
    MyHVML_TAG_FIRST_ENTRY = MyHVML_TAG__TEXT,
    MyHVML_TAG_LAST_ENTRY  = MyHVML_TAG__END_OF_FILE + 1,
};
...
enum myhvml_namespace {
    ...
    MyHVML_NAMESPACE_HTML,
    MyHVML_NAMESPACE_XML,

    /* MyHVML_NAMESPACE_ANY == MyHVML_NAMESPACE_LAST_ENTRY */
    MyHVML_NAMESPACE_ANY        = MyHVML_NAMESPACE_XML,
    MyHVML_NAMESPACE_LAST_ENTRY = MyHVML_NAMESPACE_XML,
}
